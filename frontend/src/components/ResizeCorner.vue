<template>
  <div class="resize-corner">
    ...
    >
      <path d="M16 0V16H0L16 0Z" fill="var(--figma-color-icon-secondary)" />
      <path d="M6.22577 16H3L16 3V6.22576L6.22577 16Z" fill="var(--figma-color-bg)" />
      <path d="M11.8602 16H8.63441L16 8.63441V11.8602L11.8602 16Z" fill="var(--figma-color-bg)" />
    </svg>
  </div>
</template>
